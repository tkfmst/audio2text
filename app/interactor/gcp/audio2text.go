...
import (
	...
	boundry_input "example.com/audio2text/app/boundary/input"
	boundry_output "example.com/audio2text/app/boundary/output"
	"example.com/audio2text/app/data/input"
	"example.com/audio2text/app/data/output"
	"example.com/audio2text/app/if/api"
	"example.com/audio2text/app/service"
	"example.com/audio2text/entity"
	"example.com/audio2text/util/logger"
)
